      ...
      <main className="bg-white">
            ...
            <div data-reveal="left">
              ...
              <div className="flex flex-wrap gap-3">
                <Link href={`/raporty-miejskie/${activeCity}`} className="btn-primary inline-flex items-center gap-2">
                  Otwórz raport: {active.cityName} <ArrowRight size={14} />
                </Link>
                <Link href="/przewodnik-flex" className="btn-outline">
                  Wróć do Przewodnika Flex
                </Link>
              </div>
            </div>
        ...
        <section className="py-20 border-b border-[#e7e8ea]" data-reveal>
          <div className="container-colliers">
            <p className="overline mb-7">Miasta</p>
        ...
        <section className="py-20 bg-[#f8fbff] border-b border-[#e7e8ea]" data-reveal>
          <div className="container-colliers">
            <p className="overline mb-7">Porównanie rynków</p>
            <div className="overflow-x-auto border border-[#d9e4fa] bg-white">
              <table className="w-full min-w-[980px] text-left">
                <thead>
                  <tr className="border-b border-[#e7e8ea]">
                    <th className="px-5 py-4 text-[11px] uppercase tracking-[0.18em] text-[#1C54F4]">Miasto</th>
                    <th className="px-5 py-4 text-[11px] uppercase tracking-[0.18em] text-[#1C54F4]">Powierzchnia</th>
                    <th className="px-5 py-4 text-[11px] uppercase tracking-[0.18em] text-[#1C54F4]">Zajętość</th>
                    <th className="px-5 py-4 text-[11px] uppercase tracking-[0.18em] text-[#1C54F4]">Liczba biur</th>
                    <th className="px-5 py-4 text-[11px] uppercase tracking-[0.18em] text-[#1C54F4]">Charakter rynku</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <div className="container-colliers">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/porownaj" className="btn-primary-bright inline-flex items-center gap-2">
                Przejdź do porównywarki <ArrowRight size={14} />
              </Link>
