...
export default function UnavailableValueTooltip({
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute left-1/2 top-[calc(100%+10px)] z-20 w-72 -translate-x-1/2 rounded-none border border-[#dbe4f8] bg-white px-3 py-2 text-[11px] font-normal leading-relaxed text-[#5c6d97] opacity-0 shadow-[0_12px_30px_rgba(0,7,89,0.12)] transition-all duration-200 group-hover:translate-y-0 group-hover:opacity-100 group-focus:translate-y-0 group-focus:opacity-100">
        {tooltip}
      </span>
    </span>
  )
